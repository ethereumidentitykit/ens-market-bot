...
export const TOKEN_METADATA: Record<string, TokenMetadata> = {
  ...
  // Polygon (matic-mainnet alias - Alchemy API uses both)
  'matic-mainnet:0x7ceb23fd6bc0add59e62ac25578270cff1b9f619': { symbol: 'WETH', decimals: 18 },
  'matic-mainnet:0x2791bca1f2de4661ed88a30c99a7a9449aa84174': { symbol: 'USDC', decimals: 6 },
  'matic-mainnet:0xc2132d05d31c914a87c6611c10748aeb04b58e8f': { symbol: 'USDT', decimals: 6 },
  'matic-mainnet:0x8f3cf7ad23cd3cadbd9735aff958023239c6a063': { symbol: 'DAI', decimals: 18 },
  'matic-mainnet:0x1bfd67037b42cf73acf2047067bd4f2c47d9bfd6': { symbol: 'WBTC', decimals: 8 },
  'matic-mainnet:0x1a1b87e058b8d9add50c8a1ede80376fde1e2e13': { symbol: 'wstETH', decimals: 18 },
  'matic-mainnet:0xc3c7d422809852031b44ab29eec9f1eff2a58756': { symbol: 'LDO', decimals: 18 },
  'matic-mainnet:0x6f7c932e7684666c9fd1d44527765433e01ff61d': { symbol: 'MKR', decimals: 18 },
  'matic-mainnet:0x50b728d8d964fd00c2d0aad81718b71311fef68a': { symbol: 'SNX', decimals: 18 },
  'matic-mainnet:0x172370d5cd63279efa6d502dab29171933a610af': { symbol: 'CRV', decimals: 18 },
  'matic-mainnet:0x8505b9d2254ad4deb0916dd7d59ade791f0e25b4': { symbol: 'COMP', decimals: 18 },
  'matic-mainnet:0x9a71012b13ca4d3d0cdc72a177df3ef03b0e76a3': { symbol: 'BAL', decimals: 18 },
  'matic-mainnet:0x0000000000000000000000000000000000001010': { symbol: 'MATIC', decimals: 18 },
  'matic-mainnet:0x111111111117dc0aa78b770fa6a738034120c302': { symbol: '1INCH', decimals: 18 },
